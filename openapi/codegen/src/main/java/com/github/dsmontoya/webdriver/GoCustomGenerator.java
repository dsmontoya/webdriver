package com.github.dsmontoya.webdriver;
...
public class GoCustomGenerator extends AbstractGoCodegen {

    private final Logger LOGGER = LoggerFactory.getLogger(GoCustomGenerator.class);
    ...
    public GoCustomGenerator() {
        ...
        outputFolder = "generated-code/go-custom";
        embeddedTemplateDir = templateDir = "go-custom";
        usesOptionals = false;
        ...
        for (ModelMap m : objs.getModels()) {
            ...
            for (CodegenProperty param : Iterables.concat(model.vars, model.allVars, model.requiredVars, model.optionalVars)) {
                ...
                if (param.isDateTime) {
                    ...
                    param.dataType = "Nilable" + Character.toUpperCase(param.dataType.charAt(0))
