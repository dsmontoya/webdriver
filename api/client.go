...
// APIClient manages communication with the Selenium WebDriver API v1.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.TimeoutsApi = (*TimeoutsApiService)(&c.common)
